...
<body>
    ...
    <div id="wrapper">
        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav navbar-collapse slimscrollsidebar">
                <ul class="nav" id="side-menu">
                    ...
                    <li> <a href="/karyawan/manage-pengajuan-cuti" class="waves-effect "><i class="zmdi zmdi-settings zmdi-hc-fw fa-fw"></i> <span class="hide-menu"> Pengajuan Cuti  </span></a></li>
                    @endif
        ...
        <div id="page-wrapper">
            @yield('konten')
            <footer class="footer text-center"> {{date('Y')}} &copy; SI CUTKAR template by themedesigner.in created by Fauzi </footer>
        </div>
        <!-- /#page-wrapper -->
    </div>
    <!-- /#wrapper -->
